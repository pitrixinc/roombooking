...
{/*
        ...
        */}
            ...
            <div onClick={() => router.push(`/`)} class="cursor-pointer flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                </svg>

                <span class="mx-2 text-sm font-medium">Discover Rooms</span>
            </div> 
            ...
            <div onClick={() => router.push(`/account/${id}/favorites`)} class="cursor-pointer flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <span class="mx-2 text-sm font-medium">Booked Rooms</span>
            </div>
        ...
        <div class="mt-6">
            <div class="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Explore all local events available and view all the events you have booked</p>
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div onClick={() => setShowLogoutModal(true)} class="cursor-pointer text-gray-500 transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
<div className='fixed bottom-0 left-0 z-10 w-full md:hidden lg:hidden bg-white border-t border-gray-400 p-4 flex justify-between'>
  ...
  <span className="btm-nav-label text-sm">Discover Rooms</span>
  </button>
  ...
  <span className="btm-nav-label text-sm">Booked Rooms</span>
  </button>
